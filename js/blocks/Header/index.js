import { getActivityMessage, timeDifference } from "../../utils/index.js";
...
const createRecordElement = (record) => {
    ...
    username.textContent = record.username ?? '@사용자'; 
    ...
    time.textContent = record.timestamp ? timeDifference(record.timestamp) : '시간 알 수 없음';
